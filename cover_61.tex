...
\thispagestyle{fancy}
 ...
 \begin{tabular}{l l} 
   ...
   Date et lieu de naissance: & \textbf{15 Mars 1984 à Palafrugell (Espagne)} \\ \\ [-2ex]
...
\begin{table}[h]
\begin{tabular}{llll}
\multirow{}{}{Publications:}  & \textbf{Revues:}              & \textbf{3}  & 3 en auteur correspondant          \\
...
\end{tabular}
\end{table}
Mots-cl\'{e}s: Medical Image Analysis, Pattern Recognition, Mechine Learning,
Computer Aided Diagnosis, Computer Vision, Segmentation, Statistical Models,
Breast Cancer
