...
\item[Classification automatique d'Eud\`{e}me Maculaire Diab\'{e}tique
  ...
  pour la détection de patients atteints d'EMD dans les images de Tomographie en
Cohérence Optique (TCO): (i) une méthode supervisée utilisant des descripteurs de
  ...
  existantes publiés dans~\cite{massich2016classifying}.
...
\item[Développement de syst\`{e}mes DAO pour des applications en
  ...
  ces différentes applications donnant lieu aux publications suivantes
  ~\cite{
...
trouver l'orientation de fibres~\cite{belkacemi2016wood,belkacemi2015nondestructive}.
...
donnant lieu aux publications suivantes
  ~\cite{
